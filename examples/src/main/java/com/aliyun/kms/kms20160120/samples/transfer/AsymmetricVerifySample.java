package com.aliyun.kms.kms20160120.samples.transfer;
...
public class AsymmetricVerifySample {

    public static void main(String[] args) throws Exception {
        newUserAsymmetricVerify();
        beforeMigrateAsymmetricVerify();
        afterMigrateAsymmetricVerify();
    }

    /**
     * 新接入用户可以参考此方法调用KMS实例网关的服务。
     */
    private static void newUserAsymmetricVerify() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void beforeMigrateAsymmetricVerify() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void afterMigrateAsymmetricVerify() throws Exception {
        //创建kms config并设置相应参数
        ...
        //.setCa("your-ca-certificate-content"));
        //创建kms client
        Client client = new TransferClient(config, kmsConfig);
        asymmetricVerify(client);
    }
     ...
     * 使用KMS API调用DKMS密钥
     */
    public static void asymmetricVerify(Client client) {
        ...
        try {
            ...
            AsymmetricVerifyResponse response = client.asymmetricVerifyWithOptions(request, runtimeOptions);
