...
public class GetPublicKeySample {
    ...
    public static void main(String[] args) throws Exception {
        newUserGetPublicKey();
        beforeMigrateGetPublicKey();
        afterMigrateGetPublicKey();
    }

    /**
     * 新接入用户可以参考此方法调用KMS实例网关的服务。
     */
    private static void newUserGetPublicKey() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void beforeMigrateGetPublicKey() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void afterMigrateGetPublicKey() throws Exception {
        //创建kms config并设置相应参数
    ...
    public static void getPublicKey(Client client) {
        ...
        try {
            ...
            GetPublicKeyResponse response = client.getPublicKeyWithOptions(request, runtimeOptions);
            System.out.printf("KeyId: %s%n", response.getBody().getKeyId());
            System.out.printf("KeyVersionId: %s%n", response.getBody().getKeyVersionId());
            System.out.printf("PublicKey: %s%n", response.getBody().getPublicKey());
