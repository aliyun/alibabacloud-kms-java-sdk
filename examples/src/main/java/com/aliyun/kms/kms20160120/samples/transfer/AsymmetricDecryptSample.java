...
public class AsymmetricDecryptSample {
    public static void main(String[] args) throws Exception {
        newUserAsymmetricDecrypt();
        beforeMigrateAsymmetricDecrypt();
        afterMigrateAsymmetricDecrypt();
    }

    /**
     * 新接入用户可以参考此方法调用KMS实例网关的服务。
     */
    private static void newUserAsymmetricDecrypt() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void beforeMigrateAsymmetricDecrypt() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void afterMigrateAsymmetricDecrypt() throws Exception {
        //创建kms config并设置相应参数
    ...
    private static void asymmetricDecrypt(Client client) {
        ...
        try {
            ...
            AsymmetricDecryptResponse response = client.asymmetricDecryptWithOptions(request, runtimeOptions);
