...
public class ListAliases {
    ...
    public static com.aliyun.kms20160120.models.ListAliasesResponse listAliases(com.aliyun.kms.kms20160120.Client client, Integer pageNumber, Integer pageSize) throws Exception {
        com.aliyun.kms20160120.models.ListAliasesRequest request = new com.aliyun.kms20160120.models.ListAliasesRequest()
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Config openApiConfig = ListAliases.createOpenApiConfig(com.aliyun.darabonba.env.EnvClient.getEnv("ALIBABA_CLOUD_ACCESS_KEY_ID"), com.aliyun.darabonba.env.EnvClient.getEnv("ALIBABA_CLOUD_ACCESS_KEY_SECRET"), "your region id");
        com.aliyun.kms.kms20160120.Client client = ListAliases.createClient(openApiConfig);
        ...
        com.aliyun.kms20160120.models.ListAliasesResponse response = ListAliases.listAliases(client, pageNumber, pageSize);
