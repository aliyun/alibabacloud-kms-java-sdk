...
public class GenerateDataKeySample {
    ...
    public static void main(String[] args) throws Exception {
        newUserGenerateDataKey();
        beforeMigrateGenerateDataKey();
        afterMigrateGenerateDataKey();
    }

    /**
     * 新接入用户可以参考此方法调用KMS实例网关的服务。
     */
    private static void newUserGenerateDataKey() throws Exception {
        //创建kms config并设置相应参数
     ...
     * @throws Exception
     */
    private static void beforeMigrateGenerateDataKey() throws Exception {
        //创建kms config并设置相应参数
     ...
     * 生成数据密钥
     */
    public static void generateDataKey(Client client) {
