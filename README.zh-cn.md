...
#### 参考以下示例代码调用KMS Encrypt API。更多API示例参考 [operation samples](./examples/src/main/java/com/aliyun/kms/kms20160120/samples/operation)
```Java
...
#### 参考以下示例代码调用KMS CreateKey API。更多API示例参考 [manage samples](./examples/src/main/java/com/aliyun/kms/kms20160120/samples/manage)
```Java
...
#### 参考以下示例代码调用KMS CreateKey API 和 Encrypt API。更多API示例参考 [operation samples](./examples/src/main/java/com/aliyun/kms/kms20160120/samples/operation) 和 [manage samples](./examples/src/main/java/com/aliyun/kms/kms20160120/samples/manage)
```Java
...
#### 参考以下示例代码调用KMS API。更多API示例参考 [kms transfer samples](./examples/src/main/java/com/aliyun/kms/kms20160120/samples/transfer)
```Java
